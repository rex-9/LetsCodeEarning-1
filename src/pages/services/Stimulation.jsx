import { ServicesStimulation } from "../../assets";
...
function Stimulation() {
  return (
    <Wrapper>
      <ServiceTextOverlay
        img={ServicesStimulation}
        href={["STIMULATION OVARIENNE", "/services/stimulation"]}
        heading="STIMULATION OVARIENNE"
      />
      <section className="px-4 py-10 md:px-24 md:py-20">
        <ServiceTextSectionOne titleHeading="STIMULATION OVARIENNE" />
