import { ServicesBlocOperate } from "../../assets";
...
function BlocOperate() {
  return (
    <Wrapper>
      <ServiceTextOverlay
        img={ServicesBlocOperate}
        href={["Bloc Operatoire", "/services/bloc-operate"]}
        heading='BLOC OPERATOIRE'
      />
      <section className="px-4 py-10 md:px-24 md:py-20">
        <ServiceTextSectionOne titleHeading="BLOC OPERATOIRE" />
