import { ServicesInsemination } from "../../assets";
...
function Insemination() {
  return (
    <Wrapper>
    <ServiceTextOverlay
      img={ServicesInsemination}
      href={["INSEMINATION INTRA UTERINE", "/services/insemination"]}
      heading="INSEMINATION INTRA UTERINE"
    />
    <section className="px-4 py-10 md:px-24 md:py-20">
      <ServiceTextSectionOne titleHeading="INSEMINATION INTRA UTERINE" />
