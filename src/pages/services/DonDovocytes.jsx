import { ServicesDonDOvocytes } from "../../assets";
...
function DonDovocytes() {
  return (
    <Wrapper>
      <ServiceTextOverlay
        img={ServicesDonDOvocytes}
        href={["DON D'OVOCYTES", "/services/don-do-ovocytes"]}
        heading="DON D'OVOCYTES"
      />
      <section className="px-4 py-10 md:px-24 md:py-20">
        <ServiceTextSectionOne titleHeading="DON D'OVOCYTES" />
