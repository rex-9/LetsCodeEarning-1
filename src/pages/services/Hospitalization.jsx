import { ServicesHospitalization } from "../../assets";
...
function Hospitalization() {
  return (
    <Wrapper>
      <ServiceTextOverlay
        img={ServicesHospitalization}
        href={["HOSPITALIZATION", "/services/hospitalization"]}
        heading="HOSPITALIZATION"
      />
      <section className="px-4 py-10 md:px-24 md:py-20">
        <ServiceTextSectionOne titleHeading="HOSPITALIZATION" />
