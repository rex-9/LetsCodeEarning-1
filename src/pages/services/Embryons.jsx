import { ServicesEmbryons } from "../../assets";
...
function Embryons() {
  return (
    <Wrapper>
      <ServiceTextOverlay
        img={ServicesEmbryons}
        href={["ACCEIL D'EMBRYONS", "/services/embryons"]}
        heading="ACCEIL D'EMBRYONS"
      />
      <section className="px-4 py-10 md:px-24 md:py-20">
        <ServiceTextSectionOne titleHeading="ACCEIL D'EMBRYONS" />
