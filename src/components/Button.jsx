...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-[0.375rem] md:text-medium text-body-text-1 font-NunitoSans text-neutral-100  disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
