...
const Banner = ({ heading, subheading, img, alt }) => {
  return (
    <div className="round grid h-16 grid-cols-2 font-NunitoSans md:h-44">
      ...
      <img
        src={img}
        alt={alt}
        className="w-full block h-44 object-cover object-mobile-banner md:object-desktop-banner"
      />
    </div>
  );
};
